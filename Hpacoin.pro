...
# also add new translations to bitcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/bitcoin*.ts)
...
macx:ICON = src/qt/res/icons/Hpacoin.icns
macx:TARGET = "UNCoin"
