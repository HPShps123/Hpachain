...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "Nov 28,2016. The Hpacoin released, www.Hpacoin.org";
        CTransaction txNew;
        ...
        genesis.nTime    = GENESIS_BLOCK_TIME;
             ...
             vSeeds.push_back(CDNSSeedData("47.91.218.254",  "47.91.218.254"));
		vSeeds.push_back(CDNSSeedData("47.52.106.70",  "47.52.106.70"));
...
public:
    CMainParams() {
      ...
      //  nLastPOWBlock = std::numeric_limits<int>::max();
        ...
        nFirstPosv2Block = 10000000;
        nFirstPosv3Block = 10000000;
        ...
        genesis.nNonce   = 12121;
        hashGenesisBlock = genesis.GetHash();
  
		
        assert(hashGenesisBlock == uint256("0x2bfce67f5723fc777727841a573f669c4a4859af7ed1ffc435303723ae69d19a"));
        assert(genesis.hashMerkleRoot == uint256("0x2ea49f53709b4e0fdb43a9e49651072eed0acbe79c2b2976bc6b10bdf1e92f61"));

        base58Prefixes[PUBKEY_ADDRESS]      = list_of(40).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SCRIPT_ADDRESS]      = list_of(130).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[SECRET_KEY]          = list_of(191).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[STEALTH_ADDRESS]     = list_of(41).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams() {
        ...
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 15778;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x82c6e4b232aec3d7563f49cc2e2e7b5eb0afe80ab34504b60ef00d48f869dc26"));
...
public:
    CRegTestParams() {
        ...
        assert(hashGenesisBlock == uint256("0xe50ef134328070be15c019c8abc0ca8448bdc3b9bed792b54dbb932378126914"));
